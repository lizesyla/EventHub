      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            <p style={{ color: colors.textMuted, fontSize: "15px", margin: 0 }}>
              Manage event details, capacity, and reservations
            </p>
          </div>
        ...
        >
          {[
            ...
            >
              <p style={{ fontSize: "26px", fontWeight: "800", color: stat.color, margin: "0 0 4px" }}>
                {stat.value}
              </p>
              <p
                style={{
        ...
        {loading ? (
          ...
          >
            <h3 style={{ color: colors.textMain, fontSize: "22px", fontWeight: "700", margin: "0 0 12px" }}>
              No events yet
            </h3>
            <p style={{ color: colors.textMuted, marginBottom: "28px" }}>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ padding: "20px" }}>
                    ...
                    >
                      <h3 style={{ color: colors.textMain, fontSize: "18px", fontWeight: "800", margin: 0 }}>
                        {event.title}
                      </h3>
                    ...
                    >
                      <div>
                        <p style={{ color: colors.textMuted, fontSize: "11px", margin: "0 0 4px", textTransform: "uppercase" }}>
                          Capacity
                        </p>
                        <p style={{ color: colors.textMain, fontSize: "18px", fontWeight: "800", margin: 0 }}>
                      ...
                      <div>
                        ...
                        <p style={{ color: colors.accent, fontSize: "18px", fontWeight: "800", margin: 0 }}>
                          {event.going_count || 0}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p style={{ color: colors.green, fontSize: "18px", fontWeight: "800", margin: 0 }}>
                    ...
                    <div style={{ display: "flex", gap: "8px" }}>
                      <button
                        ...
                        style={{
                          ...
                          fontSize: "12px",
                          fontWeight: "700",
                          cursor: event.status === "past" ? "not-allowed" : "pointer",
                          opacity: event.status === "past" ? 0.6 : 1,
                        }}
                      >
                        Archive
                      </button>
